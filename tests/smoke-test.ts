...
const cases: { operation: string; method: string; path: string; args: string[] }[] = [
...

  {
    ...
    args: ["registry","update-api-document","namespace_","slug"],
  },

  {
    ...
    method: "DELETE",
    path: "/v1/apis/{namespace}/{slug}",
    args: ["registry","delete-api-document","namespace_","slug"],
  },

  {
    ...
    args: ["registry","retrieve-api-document-version","namespace_","slug","semver"],
  },

  {
    ...
    method: "PATCH",
    path: "/v1/apis/{namespace}/{slug}/version/{semver}",
    args: ["registry","update-api-document-version","namespace_","slug","semver","--document","document"],
  },

  {
    ...
    method: "DELETE",
    path: "/v1/apis/{namespace}/{slug}/version/{semver}",
    args: ["registry","delete-api-document-version","namespace_","slug","semver"],
  },

  {
    ...
    args: ["registry","list-api-document-version-metadata","namespace_","slug","semver"],
  },

  {
    ...
    args: ["registry","create-api-document-version","namespace_","slug","--version-command","version","--document","document"],
  },

  {
    ...
    args: ["registry","create-api-document-access-group","namespace_","slug","--access-group-slug","accessGroupSlug"],
  },

  {
    ...
    method: "DELETE",
    path: "/v1/apis/{namespace}/{slug}/access-group",
    args: ["registry","delete-api-document-access-group","namespace_","slug","--access-group-slug","accessGroupSlug"],
  },
...

  {
    ...
    args: ["schemas","update","namespace_","slug"],
  },

  {
    ...
    method: "DELETE",
    path: "/v1/schemas/{namespace}/{slug}",
    args: ["schemas","delete","namespace_","slug"],
  },

  {
    ...
    args: ["schemas","retrieve-version","namespace_","slug","semver"],
  },

  {
    ...
    method: "DELETE",
    path: "/v1/schemas/{namespace}/{slug}/version/{semver}",
    args: ["schemas","delete-version","namespace_","slug","semver"],
  },

  {
    ...
    args: ["schemas","create-version","namespace_","slug","--version-command","version","--document","document"],
  },

  {
    ...
    args: ["schemas","create-access-group","namespace_","slug","--access-group-slug","accessGroupSlug"],
  },

  {
    ...
    method: "DELETE",
    path: "/v1/schemas/{namespace}/{slug}/access-group",
    args: ["schemas","delete-access-group","namespace_","slug","--access-group-slug","accessGroupSlug"],
  },
...

  {
    ...
    args: ["rules","update-ruleset","namespace_","slug"],
  },

  {
    ...
    method: "DELETE",
    path: "/v1/rulesets/{namespace}/{slug}",
    args: ["rules","delete-ruleset","namespace_","slug"],
  },

  {
    ...
    method: "GET",
    path: "/v1/rulesets/{namespace}/{slug}",
    args: ["rules","retrieve-ruleset-document","namespace_","slug"],
  },

  {
    ...
    args: ["rules","create-ruleset-access-group","namespace_","slug","--access-group-slug","accessGroupSlug"],
  },

  {
    ...
    method: "DELETE",
    path: "/v1/rulesets/{namespace}/{slug}/access-group",
    args: ["rules","delete-ruleset-access-group","namespace_","slug","--access-group-slug","accessGroupSlug"],
  },
